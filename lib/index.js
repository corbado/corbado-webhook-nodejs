...
class Webhook {
    ...
    WEBHOOK_ACTION = {
        AUTH_METHODS: 'authMethods', PASSWORD_VERIFY: 'passwordVerify'
    };
    ...
    getAuthMethodsRequest(req) {
        ...
        return {
            id: data.id, projectID: data.projectID, action: data.action, data: {
    ...
    getPasswordVerifyRequest(req) {
        ...
        return {
            id: data.id, projectID: data.projectID, action: this.WEBHOOK_ACTION.PASSWORD_VERIFY, data: {
    ...
    getPasswordVerifyResponse(success, responseID = '') {
        return {
            responseID: responseID, data: {success}
        };
    }

};

module.exports = {Webhook: Webhook, webhookMiddleware};